...
export default class Bacchus extends Component {
    ...
    componentDidUpdate(prevProps,prevState) {
        alert(`Stock Bacchus di Update! Stock sebelumnya : ${prevState.stock} `)
    }

    shouldComponentUpdate() {
        return window.confirm(`Anda yakin membeli Bacchus?`);
    }
    ...
    <Rowcard>
        <ColumnCard>
            ...
            <div> 
                ...
                <Image src ="https://images.reverb.com/image/upload/s--KhNW_JcH--/t_card-square/v1546230574/rk2yq8dwp253wb9mt4gr.jpg" alt=""/>
